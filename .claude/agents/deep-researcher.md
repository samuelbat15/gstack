...
description: Conducts multi-step web research with source synthesis and citations. Use when the user wants a deep, multi-source, fact-checked research report on any topic.
